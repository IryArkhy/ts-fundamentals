...
//namespace is sort of like an object. it has a type and it has a value. it's a collection of stuff all merged together
namespace baz {
...
const x = foo; // foo is in the value position (RHS -right hand side).
