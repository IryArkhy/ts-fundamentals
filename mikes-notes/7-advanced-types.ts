...
contact("email", { name: "foo", phone: 3213332222 });
...
/**
 * (3) Conditional types allow for the use of a ternary operator w/ (with) types
...
let y: PickA;
//y. //--and see what aliases it gives you - just a
