...
myAny.foo.bar.baz; //no error
myUnknown.foo; //error. You must narrow it some way before you use it
...
let y = 4 as string | number //| boolean; //uncomment if nessesary to see the error at the bottom (y: never|boolean)
